...
[zabbix_create.ini](https://github.com/bubalush/zabbix-tasks/tree/ndolya_day2/day2/scripts/zabbix_create.ini) - Define veriables for [zabbix_create.py](https://github.com/bubalush/zabbix-tasks/tree/ndolya_day2/day2/scripts/zabbix_create.py)
