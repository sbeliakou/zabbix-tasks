yum install zip unzip net-tools vim tomcat tomcat-webapps python python-pip -y
...
###WAR-deployment###
if [ ! -e "/var/lib/tomcat/webapps/hello-world.war" ]
   then
	cp /home/vagrant/vb-share/hello-world.war /var/lib/tomcat/webapps
fi
...
###Python Check###
wget https://raw.githubusercontent.com/VadzimTarasiuk/zabbix-tasks/day2/day2/zabbix-task.py
python zabbix-task.py
